...
class HopSkipJump(MinimizationAttack):
    ...
    def run(
        ...
        **kwargs: Any,
        ...
        for step in range(self.steps):
            ...
            # print("step number is {}/{}".format(step, self.steps))
            ...
            if self.stepsize_search == "geometric_progression":
                ...
                while True:
                    x_advs_proposals = ep.clip(
                        x_advs + atleast_kd(epsilons, x_advs.ndim) * update, -1, 1
                    )
                ...
                # Update the sample.
                x_advs = ep.clip(
                    x_advs + atleast_kd(epsilons, update.ndim) * update, -1, 1
                )
    ...
    def approximate_gradients(
        ...
        # grad /= ep.norms.l2(atleast_kd(flatten(grad, keep=1), grad.ndim)) + 1e-12
        grad /= atleast_kd(ep.norms.l2(flatten(grad, keep=1),-1),grad.ndim) + 1e-12
